...
const TimeUtil = {
    ...
    MAX_INDEX_CNT: 17,
    getTime: function (timePeriodIndex, startDay, index) {
    ...
    getDayOffset: function (startDay, timePeriodIndex, index) {
    ...
    getDay: function (lastUpdateDate, timePeriodIndex, index) {
